...
urlpatterns = [
    ...
    path('<str:uid>/view/<int:pk>/', views.view_dashboard, name='view_dashboard'),
    path('<str:uid>/editor/', views.dashboard_editor_list, name='dashboard_editor_list'),
    path('<str:uid>/editor/<int:pk>/', views.dashboard_editor, name='dashboard_editor'),
